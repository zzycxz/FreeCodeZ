...
function buildInitAgentsPrompt(params: {
  ...
  return [
    ...
    `- Existing hidden instruction candidates: ${join(params.workingDirectory, ".freecodez", "AGENTS.md")} and ${join(params.workingDirectory, ".agents", "AGENTS.md")}`,
    "- File name must be exactly AGENTS.md.",
    "- This command targets the current workspace only. Do not write ~/.freecodez/AGENTS.md.",
