...
export function SettingsPage({
  ...
  // FreeCodeZ fork(model-provider-intake R1):bigmodel+zai 账号族整体移除后，
  // 使用统计不再绑定账号 Coding Plan 来源；来源恒空时 Coding Plan tab 自动隐藏。
  ...
  const checkingUsageCodingPlanTab = usageProviderSettingsLoading;
            ...
            <div className="flex h-full flex-col">
              ...
              <div className="max-lg:hidden">
                <WorkspaceSidebarFooter
                  ...
                  workspacePath={captionWorkspacePath ?? undefined}
