...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like FreeCodeZ to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let FreeCodeZ remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting FreeCodeZ",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen FreeCodeZ.",
  ...
  "startup.global.starting_services": "Starting FreeCodeZ",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "FreeCodeZ will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another FreeCodeZ or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen FreeCodeZ. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen FreeCodeZ to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen FreeCodeZ.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a FreeCodeZ restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into FreeCodeZ",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to FreeCodeZ and try again",
  ...
  "modelTrajectory.empty": "No model calls recorded (only FreeCodeZ Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About FreeCodeZ",
  ...
  "forceUpdate.title": "Update FreeCodeZ to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart FreeCodeZ to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the FreeCodeZ CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "FreeCodeZ checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the FreeCodeZ terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While FreeCodeZ is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the FreeCodeZ installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching FreeCodeZ task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by FreeCodeZ",
  ...
  "resourceManager.storage.diskUsage": "FreeCodeZ uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the FreeCodeZ desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "FreeCodeZ could not verify its Windows secure import component. Reinstall or update FreeCodeZ before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, FreeCodeZ will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.searchVision.nativeSearch.label": "Native search",
  "settings.searchVision.nativeSearch.native": "The current session model endpoint supports native web search; no key required",
  "settings.searchVision.nativeSearch.fallback": "The current session model endpoint has no native search; falls back to configured keys and the anonymous AnySearch tail",
  "settings.searchVision.nativeSearch.unknown": "Current model unavailable; native search status unknown",
  "settings.searchVision.nativeSearch.badge.native": "Native",
  "settings.searchVision.nativeSearch.badge.fallback": "Fallback",
  "settings.searchVision.nativeSearch.badge.unknown": "Unknown",
  ...
  "settings.searchVision.imageSearch.description":
    "SerpAPI → Brave → Openverse (zero-key, CC images only); Brave key shared with web search; safe search & region also apply to Brave web results",
  ...
  "settings.searchVision.key.save": "Save",
  "settings.searchVision.key.saved": "Saved",
  "settings.searchVision.key.setBadge": "Set",
  "settings.searchVision.key.clear": "Clear",
  "settings.searchVision.key.placeholder": "Enter API Key and press Enter to save",
  "settings.searchVision.key.placeholderSet": "Set (enter a new value to overwrite)",
  "settings.searchVision.key.anysearchPlaceholder": "Optional: leave empty for anonymous access; enter a key to authenticate",
  "settings.searchVision.safeSearch": "Safe search",
  "settings.searchVision.country": "Country",
  "settings.searchVision.countrySave": "Save",
  "settings.searchVision.countryPlaceholder": "Two-letter code, e.g. cn; empty = no restriction",
  "settings.searchVision.visionModel.title": "Vision model",
  "settings.searchVision.visionModel.description": "Model for image understanding; defaults to the session model",
  "settings.searchVision.visionModel.followSession": "Follow current session model",
  "settings.searchVision.webfetch.title": "Web page to Markdown",
  "settings.searchVision.webfetch.description": "Built in, zero config",
  "settings.mcpTitle": "MCP Servers",
  "settings.mcp.description": "Manage MCP server configurations used by FreeCodeZ Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "FreeCodeZ provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This FreeCodeZ Agent cannot refresh OAuth status. Upgrade or restart FreeCodeZ, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into FreeCodeZ",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in FreeCodeZ.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. FreeCodeZ uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in FreeCodeZ after purchase or setup.",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for FreeCodeZ built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into FreeCodeZ. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. FreeCodeZ follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into FreeCodeZ",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by FreeCodeZ Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend FreeCodeZ with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into FreeCodeZ and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. FreeCodeZ follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into FreeCodeZ",
  ...
  "settings.commands.description":
    "Manage FreeCodeZ Agent .md command files. Commands can be invoked with /command-name in chat.",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into FreeCodeZ. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. FreeCodeZ follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into FreeCodeZ",
  ...
  "settingsSync.action.finish": "Start using FreeCodeZ",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current FreeCodeZ settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to FreeCodeZ",
  ...
  "onboarding.welcome.title": "Welcome to FreeCodeZ",
  "onboarding.welcome.start": "Start FreeCodeZ",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while FreeCodeZ imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "FreeCodeZ will copy {source} to {target}.\nIf the target file already exists, the FreeCodeZ default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask FreeCodeZ anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask FreeCodeZ anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, FreeCodeZ will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want FreeCodeZ to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart FreeCodeZ app and retry, or ask FreeCodeZ to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with FreeCodeZ in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for FreeCodeZ: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with FreeCodeZ in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current FreeCodeZ Agent session",
  ...
  "feedback.submit.template.section.copyErrorHeading": "FreeCodeZ Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while FreeCodeZ is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task FreeCodeZ can work on in the background, including the expected result and any constraints…",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart FreeCodeZ",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart FreeCodeZ to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified FreeCodeZ plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "FreeCodeZ will verify the Computer Use tools against the exact session when your first session starts.",
