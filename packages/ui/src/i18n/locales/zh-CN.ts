...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 FreeCodeZ 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 FreeCodeZ 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 FreeCodeZ 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 FreeCodeZ",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 FreeCodeZ。",
  ...
  "startup.global.starting_services": "正在启动 FreeCodeZ",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 FreeCodeZ。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "startup.global.error.lock_timeout":
    "等待数据库写锁超时。请检查其他 FreeCodeZ 或 CLI 进程是否仍在更新数据，待其完成后点击重试。",
  "startup.global.error.sql_failed":
    "准备过程未完成。请复制诊断信息查看日志，排除问题后手动重试。应用不会自动重试。",
  "startup.global.error.startup_status_timeout":
    "未能收到启动状态。请退出并重新打开 FreeCodeZ；如果仍失败，请提供诊断信息。",
  "startup.global.error.transport_closed":
    "数据准备进程意外退出或连接中断。请退出并重新打开 FreeCodeZ，应用会重新检查迁移记录。",
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 FreeCodeZ。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 FreeCodeZ 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 FreeCodeZ",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 FreeCodeZ 后重试",
  ...
  // 登录
  "welcome.title": "Welcome to FreeCodeZ",
  ...
  "logout.confirm.title": "断开连接并重启 FreeCodeZ？",
  ...
  // 左下角 Provider/Key 状态指示器（P2 §4.6 侧栏底栏改造）
  "sidebar.providerStatus.notConfigured": "未配置 Key",
  "sidebar.providerStatus.ready": "Key 有效",
  "sidebar.providerStatus.invalid": "Key 失效或配置有误",
  "sidebar.providerStatus.manage": "管理 Provider",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 FreeCodeZ Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 FreeCodeZ",
  ...
  "forceUpdate.title": "需要升级 FreeCodeZ 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 FreeCodeZ 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 FreeCodeZ CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 FreeCodeZ 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 FreeCodeZ 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 FreeCodeZ 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 FreeCodeZ 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "FreeCodeZ 总占用",
  ...
  "resourceManager.storage.diskUsage": "FreeCodeZ 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 FreeCodeZ 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "FreeCodeZ 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 FreeCodeZ。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。FreeCodeZ 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.searchVision.nativeSearch.label": "原生搜索",
  "settings.searchVision.nativeSearch.native": "当前会话模型端点支持原生联网搜索,无需配置任何 key",
  "settings.searchVision.nativeSearch.fallback": "当前会话模型端点无原生搜索,按已配 key 与 AnySearch 匿名尾链降级",
  "settings.searchVision.nativeSearch.unknown": "暂无法读取当前模型,原生搜索状态未知",
  "settings.searchVision.nativeSearch.badge.native": "原生可用",
  "settings.searchVision.nativeSearch.badge.fallback": "回退链",
  "settings.searchVision.nativeSearch.badge.unknown": "未知",
  "settings.searchVision.summaryMode": "搜索结果摘要",
  "settings.searchVision.imageSearch.title": "图片搜索",
  "settings.searchVision.imageSearch.description":
    "SerpAPI → Brave → Openverse(零 key,仅 CC 图);Brave key 与网页搜索共用,安全搜索/地区亦作用于 Brave 网页源",
  "settings.searchVision.key.serpapi": "SerpAPI",
  "settings.searchVision.key.brave": "Brave Search",
  "settings.searchVision.key.exa": "Exa",
  "settings.searchVision.key.linkup": "Linkup",
  "settings.searchVision.key.anysearch": "AnySearch",
  "settings.searchVision.key.save": "保存",
  "settings.searchVision.key.saved": "已保存",
  "settings.searchVision.key.setBadge": "已设置",
  "settings.searchVision.key.clear": "清除",
  "settings.searchVision.key.placeholder": "输入 API Key 并回车保存",
  "settings.searchVision.key.placeholderSet": "已设置(输入新值覆盖)",
  "settings.searchVision.key.anysearchPlaceholder": "可选:留空即匿名使用,填写则携带鉴权",
  "settings.searchVision.safeSearch": "安全搜索",
  "settings.searchVision.country": "地区",
  "settings.searchVision.countrySave": "保存",
  "settings.searchVision.countryPlaceholder": "两位国家码,如 cn;留空不限制",
  "settings.searchVision.visionModel.title": "视觉模型",
  "settings.searchVision.visionModel.description": "图片理解所用模型;未选时跟随当前会话模型",
  "settings.searchVision.visionModel.followSession": "跟随当前会话模型",
  "settings.searchVision.webfetch.title": "网页转 Markdown",
  "settings.searchVision.webfetch.description": "已内置,零配置",
  "settings.mcpTitle": "MCP 服务器",
  "settings.mcp.description": "管理 FreeCodeZ Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 FreeCodeZ 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 FreeCodeZ Agent 不支持 OAuth 状态刷新。请升级或重启 FreeCodeZ，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 FreeCodeZ",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 FreeCodeZ 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。FreeCodeZ 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。FreeCodeZ 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.reasoningPreset": "档位预设",
  "settings.modelProvider.reasoningPreset.off-on": "仅开关",
  "settings.modelProvider.reasoningPreset.low-medium-high": "低 / 中 / 高",
  "settings.modelProvider.reasoningPreset.low-high-max": "低 / 高 / 最高",
  "settings.modelProvider.reasoningPreset.full-ladder": "低 / 中 / 高 / 超高 / 最高",
  "settings.modelProvider.reasoningPreset.no-reasoning": "无档位",
  "settings.modelProvider.reasoningPresetHint.off-on": "开关式思考模型（GLM-5.x 多数、qwen-plus 等）",
  "settings.modelProvider.reasoningPresetHint.low-medium-high": "通用 effort 模型，覆盖面最广",
  "settings.modelProvider.reasoningPresetHint.low-high-max": "GLM-5.3、Kimi K3 形态",
  "settings.modelProvider.reasoningPresetHint.full-ladder": "Claude 5、GPT 5 系形态",
  "settings.modelProvider.reasoningPresetHint.no-reasoning": "不发送任何推理参数，任何模型可用",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 FreeCodeZ 即可继续编码。",
  ...
  "settings.usage.entitlementServerMcpUsage": "FreeCodeZ MCP",
  ...
  "sidebar.usage.plan.mcp": "FreeCodeZ MCP",
  "sidebar.usage.plan.zcodeMcp": "FreeCodeZ MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "FreeCodeZ 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 FreeCodeZ。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。FreeCodeZ 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 FreeCodeZ",
  ...
  "settings.subagents.description": "管理 FreeCodeZ Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 FreeCodeZ 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 FreeCodeZ，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。FreeCodeZ 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 FreeCodeZ",
  ...
  "settings.commands.description":
    "管理 FreeCodeZ Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  "settings.commands.sourceFilterLabel": "来源筛选",
  "settings.commands.source.zcodeAgent": "FreeCodeZ Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 FreeCodeZ。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。FreeCodeZ 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 FreeCodeZ",
  ...
  "settingsSync.agent.zcode": "FreeCodeZ Agent",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 FreeCodeZ 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 FreeCodeZ",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 FreeCodeZ",
  "onboarding.welcome.start": "开始使用 FreeCodeZ",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 FreeCodeZ 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，FreeCodeZ 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 FreeCodeZ 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 FreeCodeZ 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 FreeCodeZ 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 FreeCodeZ 应用后重试，或让 FreeCodeZ 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 FreeCodeZ 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 FreeCodeZ 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 FreeCodeZ 修订后另存一版。",
  ...
  "chat.error.imageUnsupported": "当前模型不支持图片输入，请切换到视觉模型或使用图像理解工具。",
  "chat.error.reasoningEffortInvalid": "当前模型不接受所选推理档位，请降低档位或改用仅开关。",
  "chat.error.action.reasoningToToggle": "切换为仅开关",
  "chat.error.action.reasoningOff": "不使用推理档位",
  "chat.error.reasoningEffortFixed": "已更新推理档位，请重新发送。",
  "chat.error.reasoningEffortFixFailed": "自动修复失败，请在模型设置中手动调整推理档位。",
  "chat.composer.imageReferenceHint": "当前模型不支持直接读图，发送后将以引用+视觉工具处理。",
  ...
  "resourceManager.appUsage": "FreeCodeZ",
  ...
  "feedback.submit.template.section.copyErrorHeading": "FreeCodeZ 报错信息",
  ...
  "offPeak.keepAwakeBanner": "FreeCodeZ 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 FreeCodeZ 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "FreeCodeZ 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "FreeCodeZ 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 FreeCodeZ",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 FreeCodeZ 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 FreeCodeZ 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，FreeCodeZ 会针对该会话精确验证电脑控制工具。",
  ...
  "providerIntake.stepKey": "输入 API 密钥并验证连接",
  "providerIntake.stepModel": "选择要启用的模型",
  "providerIntake.customNameLabel": "供应商名称",
  "providerIntake.baseUrlLabel": "API 地址",
  "providerIntake.baseUrlPlaceholder": "https://api.example.com/v1",
  "providerIntake.apiTypeLabel": "接口类型",
  "providerIntake.connect": "连接",
  "providerIntake.unverified": "未能自动验证密钥（端点无模型列表），可以继续。",
  "providerIntake.modelsFetching": "加载模型列表中…",
  "providerIntake.modelsFallback": "未能拉取模型列表，已显示预设模型，可手动添加。",
  "providerIntake.modelsTitle": "启用的模型",
  "providerIntake.defaultModelLabel": "默认模型",
  "providerIntake.manualModelPlaceholder": "手动输入模型 ID",
  "providerIntake.manualModelAdd": "添加",
  "providerIntake.finish": "完成",
  "providerIntake.finishError": "保存失败，请重试。",
  "providerIntake.errInvalidKey": "这个密钥无法使用 —— 请检查是否已激活、是否有 API 访问权限。",
  "providerIntake.errRateLimited": "请求过于频繁，请稍后再试。",
  "providerIntake.errNetwork": "无法连接供应商 —— 请检查网络后重试。",
  "providerIntake.errEndpointMiss": "该端点没有模型列表接口，可手动添加模型。",
  "providerIntake.errUnknown": "出错了，请重试。",
  "providerIntake.templatesError": "供应商模板加载失败，请检查后重试。",
  "providerIntake.groupDirect": "直连厂商",
  "providerIntake.groupAggregator": "聚合平台",
  "providerIntake.groupLocal": "本地与内网",
  "providerIntake.groupOther": "其他",
  "providerIntake.localHint": "本地服务需已启动并加载模型；llama.cpp 的工具调用需启用 --jinja（当前版本默认开启）。",
};
