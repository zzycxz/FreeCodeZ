...
const zhCN: Record<string, string> = {
  ...
  "login.title": "欢迎来到 FreeCodeZ",
  "login.description": "连接账号，开始使用 FreeCodeZ",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 FreeCodeZ。",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 FreeCodeZ 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 FreeCodeZ 自动维护，无需手动配置。",
  ...
  "chat.quota.mcp.quotaExhausted": "FreeCodeZ MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 FreeCodeZ MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
