...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "freecodez";
export const DEV_ELECTRON_APP_NAME = "FreeCodeZ Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "app.freecodez.app.development";
