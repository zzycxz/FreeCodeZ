...
// FreeCodeZ fork(model-provider-intake R1):zai/bigmodel 预设模板已随账号族下线，
// 这两个 ID 仅作为旧数据迁移锚点保留（legacy importer / migrateLegacyModelProviderId），
// 不再对应 zcode-builtin.json 中的任何模板条目。
