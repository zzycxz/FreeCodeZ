...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "freecodez-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "freecodez-media";
...
export interface IPlatformService {
  ...
  /** 注册 `freecodez://share/import?code=...` 导入意图。 */
